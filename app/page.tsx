...
const copy = {
  en: {
    ...
    aboutEyebrow: "ABOUT ME", aboutTitle: "Building my future through software.",
    about1: "I’m a Software Engineering student pursuing my BSc degree, with hands-on experience building real-world software projects.",
    about2: "I’ve gained professional experience through work and internship, where I developed practical skills in software development and problem solving.",
    about3: "I learn by building, experimenting, and continuously improving as I grow into a professional software engineer.",
    fullstack: "BSc Degree", fullstackText: "Software Engineering.", product: "Work Experience",
    productText: "Hands-on software development experience.", learning: "Internship",
    learningText: "Professional and real-world learning experience.", toolkit: "TOOLKIT",
  ...
  am: {
    ...
    aboutEyebrow: "ስለእኔ", aboutTitle: "የወደፊቴን በሶፍትዌር እየገነባሁ ነው።",
    about1: "የSoftware Engineering ተማሪ ሲሆን የBSc ዲግሪዬን እየተከታተልኩ ነው፣ እውነተኛ የሶፍትዌር ፕሮጀክቶችን በመገንባትም ተግባራዊ ልምድ አግኝቻለሁ።",
    about2: "በስራ እና በኢንተርንሺፕ ያገኘሁት ልምድ በሶፍትዌር ልማት እና ችግር መፍታት ላይ ተግባራዊ ክህሎት እንዳገኝ ረድቶኛል።",
    about3: "በመገንባት፣ በመሞከር እና በተከታታይ በመሻሻል እየተማርኩ ወደ ፕሮፌሽናል የሶፍትዌር ኢንጂነርነት እያደግሁ ነው።",
    fullstack: "BSc ዲግሪ", fullstackText: "Software Engineering።", product: "የስራ ልምድ",
    productText: "ተግባራዊ የሶፍትዌር ልማት ልምድ።", learning: "ኢንተርንሺፕ",
    learningText: "የሙያ እና የእውነተኛ ስራ የመማር ልምድ።", toolkit: "መሳሪያዎቼ",
